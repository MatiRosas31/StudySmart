...
def evaluate_excercise():
    try:
        ...
        print("Contenido de 'text' antes de limpiar:", text_content)
        ...
        print("Contenido de 'text' después de limpiar:", text_content)
        try:
...
def build_prompt(data):
    ...
    prompt += "Devuelve un JSON con la siguiente estructura:\n{\n  \"feedback\": [{\"part_id\": ..., \"score\": ..., \"comment\": ...}],\n  \"overall_feedback\": ...\n}"
    return prompt
